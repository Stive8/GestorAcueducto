...
public class GUICrearLicenciaComercial extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GUICrearLicenciaComercial
     */
    ...
    private void btnCrearLicenciaComercialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearLicenciaComercialActionPerformed
        try {
            ...
            licenciaComercial = new LicenciaComercial(numeroLicencia, fechaExpedicion, fechaVencimiento, estado);
            JOptionPane.showMessageDialog(this, "Licencia comercial creada exitosamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
